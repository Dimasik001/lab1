...
paths:
  /services:
    get:
      summary: Получить список доступных сервисов и дат
      responses:
        '200':
                  ...
                  properties:
                    ...
                    availableDates:
                      ...
                      items:
                        type: string
                        format: date
                        description: Доступные даты
  /bookings:
    post:
      summary: Создать новую запись на мойку
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                serviceId:
                  type: integer
                  description: ID выбранного сервиса
                date:
                  type: string
                  format: date
    ...
    get:
      summary: Получить список записей на сегодня (для работников)
      responses:
        '200':
          description: Успешный ответ
          content:
  ...
  /bookings/{bookingId}:
    get:
      summary: Получить данные о конкретной записи
      parameters:
        - in: path
          name: bookingId
          required: true
  ...
  /payments:
    post:
      summary: Инициировать оплату услуги
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                paymentData:
                  type: object
                  description: Данные для оплаты (например, токен карты). Детали зависят от используемой платежной системы.
      responses:
        '200':
